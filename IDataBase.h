...
//------------------------------------------------------------------------------
	...
	static const int GetUserId(int& iUserId, const std::string &sLogin,
							   const std::string &sPassword);
...
//------------------------------------------------------------------------------
	...
	static const int CreateCategory(int& iCategoryId, const int iUserId,
...
//------------------------------------------------------------------------------
	...
	//				NO_SUCH_CATEGORY -4 / UNEXPECTED_ERROR -7
	static const int AddNote(int &iNoteId, const int iCategoryId, const std::string &sKeyWords);
